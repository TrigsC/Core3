...
function NabooKaadaraScreenPlay:spawnMobiles()
	...
	pNpc = spawnMobile(self.planet, "commoner_fat", 1, 5371.9, -191.4, 6736.9, 141, 0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_old", 1, 5373.5, -191.4, 6737.0, -132, 0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_fat", 1, 5372.5, -191.4, 6735.6, 12, 0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_naboo", 1, 5377.1, -192, 6632.5, 159, 0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_naboo", 1, 5377.9, -192, 6630.5, -31, 0)
	self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "commoner_naboo", 1, 5325.5, -192, 6607.4, -151, 0)
	pNpc = spawnMobile(self.planet, "commoner", 1, 5332.8, -192, 6602.2, 127, 0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_naboo", 1, 5334.6, -192, 6600.7, -45, 0)
	self:setMoodString(pNpc, "conversation")
	...
	pNpc = spawnMobile(self.planet, "commoner_naboo", 1, 5208.8, -192, 6644.8, 0, 0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_naboo", 1, 5208.8, -192, 6646.3, 180, 0)
	self:setMoodString(pNpc, "conversation")
